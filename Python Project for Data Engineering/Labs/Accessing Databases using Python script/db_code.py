...
# Read the CSV data
file_path = r'C:\Users\hirew\IBM-Data-Engineering-Portfolio\Python Project for Data Engineering\Labs\Accessing Databases using Python script\INSTRUCTOR.csv'
